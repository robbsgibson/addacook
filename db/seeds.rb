...
onion = Product.create(name: "Onion", storesectioin_id: fresh_produce.id)
chilis_south_american = Product.create(name: "Chilis (yellow South American)", storesectioin_id: fresh_produce.id)
chicken_stock_cube = Product.create(name: "Chicken stock cube", storesectioin_id: grocery.id)
bread = Product.create(name: "Bread", storesectioin_id: bakery.id)
pecans = Product.create(name: "Pecans", storesectioin_id: grocery.id)
parmesan_cheese = Product.create(name: "Parmesan cheese", storesectioin_id: grocery.id)
evaporated_milk = Product.create(name: "Evaporated Milk", storesectioin_id: grocery.id)
rice = Product.create(name: "Rice", storesectioin_id: grocery.id)
potatoes = Product.create(name: "Potatoes", storesectioin_id: fresh_produce.id)
black_olives = Product.create(name: "Black Olives", storesectioin_id: grocery.id)
...
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: chicken.id, quantity: "4", measurement: "lb")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: olive_oil.id, quantity: "1/2", measurement: "cup")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: onion.id, quantity: "1", measurement: "large")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: garlic.id, quantity: "8", measurement: "cloves")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: chilis_south_american.id, quantity: "3", measurement: "")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: chicken_stock_cube.id, quantity: "1", measurement: "")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: bread.id, quantity: "1/4", measurement: "loaf")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: pecans.id, quantity: "1/4", measurement: "lb")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: parmesan_cheese.id, quantity: "4", measurement: "ounces")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: evaporated_milk.id, quantity: "1", measurement: "can")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: rice.id, quantity: "3.5", measurement: "lb")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: eggs.id, quantity: "4", measurement: "(hard boiled)")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: potatoes.id, quantity: "6", measurement: "")
Ingredient.create(recipe_id: aji_de_gallina.id, product_id: black_olives.id, quantity: "1/2", measurement: "cup")
...
aji = Shoppinglist.create(user_id: juan.id, name: "Aji de Gallina")
